...
from app.provisioning.events import TenantCreated, emit_tenant_created, request_user_provision
...
def create_tenant_with_admin(
    ...
    *,
    ...
    request_user_provision(admin, tenant.slug, password=admin_password)
